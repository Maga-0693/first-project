...
public class Zadacha2 {
    public static void main(String[] args) {
        ...
        Zadacha1 converter = new Zadacha1(94.8, 103.8, 13.1);
...
/*Исправьте код в классе Practicum — конструктор по умолчанию больше не генерируется и возникает ошибка.
При вызове конструктора с параметрами передайте следующие значения аргументов: 94.8 для доллара, 103.8
для евро и 13.1 для юаня.

Вместо Converter - Zadacha1*/