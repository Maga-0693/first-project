package JavaCore.Kurs14.Tema4;

import JavaCore.Kurs14.Tema3.Zadacha3;
...
public class Zadacha {
    public static void main(String[] args) {
        ...
        Zadacha3 converter = new Zadacha3(); // создайте объект класса Converter
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                Zadacha3.convert (moneyBeforeSalary, currency); // вызовите метод класса Converter
            } else if (command == 2) {
...
/*В прошлый раз вы описали класс конвертера валют Converter. Дополните код финансового приложения так, чтобы
при запуске программы работала конвертация валют. Для этого нужно создать конвертер-объект и вызвать его метод.

Вместо Converter используется Zadacha3*/