...
индексы и предлагается ввести номер того, который соответствует валюте, которую он хочет заменить. Потом
программа присваивает элементу с этим индексом новое значение. Запустите код несколько раз и попробуйте
