package JavaCore.Kurs4.Tema5;

import java.util.Scanner;

public class ZadachaFinal {
...
1.Создайте цифровое меню для выбора валют при конвертации, где 1 — USD, 2 — EUR, 3 — CNY.
2.Добавьте в код приложения бесконечный цикл while и предусмотрите выход из него при выборе
пользователем команды 0.*/